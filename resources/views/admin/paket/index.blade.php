            ...
            <table class="min-w-full bg-white rounded-lg overflow-hidden border-collapse">
              <thead class="bg-indigo-600 text-white">
                <tr>
                  ...
                  <th class="py-3 px-6 text-center border">Nama</th>
                  <th class="py-3 px-6 text-center border">Harga Bulanan</th>
                  <th class="py-3 px-6 text-center border">Harga Tahunan</th>
