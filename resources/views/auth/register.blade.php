    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="mt-4">
            ...
            <x-text-input id="telepon" class="block mt-1 w-full"
                          type="text" name="telepon" :value="old('telepon')" required autocomplete="tel" />
        ...
        <div class="mt-4">
            ...
            <p class="text-sm text-gray-600 mt-1">Masukkan kode: <strong>{{ session('captcha_register') }}</strong></p>
